        ...
        <div class="stat-card p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ number_format($stats['total_discounts'] ?? 0) }}</p>
                    <p class="text-xs text-red-600 mt-1">
                        <i class="fas fa-percentage"></i> 
                        {{ $stats['active_discounts'] ?? 0 }} نشط
                    </p>
                </div>
            ...
            <div class="mt-4 flex justify-between items-center">
                <a href="{{ route('admin.discounts.index') }}" class="text-red-600 hover:text-red-800 text-sm font-medium">
                    إدارة الخصومات
                </a>
                <a href="{{ route('admin.discounts.create') }}" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-md text-xs">
                    إضافة خصم
                </a>
            </div>
        </div>
        ...
        <div class="stat-card p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $discountedProducts->count() ?? 0 }}</p>
            ...
            <div class="mt-4">
                <a href="{{ route('admin.products.index') }}?has_discount=yes" class="text-orange-600 hover:text-orange-800 text-sm font-medium">
        ...
        <div class="stat-card p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $stats['low_stock_products'] ?? 0 }}</p>
                    <p class="text-xs text-red-600 mt-1">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.products.index') }}?stock_status=low_stock" class="text-red-600 hover:text-red-800 text-sm font-medium">
                    عرض المنتجات
                </a>
            </div>
        </div>
        ...
        <div class="stat-card p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ number_format($stats['total_customers'] ?? 0) }}</p>
            ...
            <div class="mt-4">
                <a href="{{ route('admin.users.index') }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">
                    إدارة العملاء
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('admin.discounts.create') }}" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-red-50 rounded-lg">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-2xl font-bold text-red-600">{{ $stats['active_discounts'] ?? 0 }}</span>
                        <a href="{{ route('admin.discounts.index') }}?status=active" class="text-red-500 hover:text-red-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-red-50 rounded-lg">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-2xl font-bold text-orange-600">{{ $discountedProducts->count() ?? 0 }}</span>
                        <a href="{{ route('admin.products.index') }}?has_discount=yes" class="text-orange-500 hover:text-orange-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="p-4 bg-red-50 rounded-lg">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="{{ route('admin.discounts.show', $recentDiscounts->first()) }}" class="text-red-500 hover:text-red-700">
                            <i class="fas fa-eye"></i>
                        </a>
                    </div>
                    <p class="text-sm text-red-700">{{ $recentDiscounts->first()->name }}</p>
                    <p class="text-xs text-red-600">
                        @if($recentDiscounts->first()->type == 'percentage')
                            {{ $recentDiscounts->first()->value }}%
                        @else
                            {{ number_format($recentDiscounts->first()->value, 2) }} د.أ
                        @endif
                    </p>
                </div>
                @endif
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg">
            ...
            <div class="space-y-4">
                ...
                <a href="{{ route('admin.discounts.create') }}" class="flex items-center justify-between p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors group">
                    <div class="flex items-center">
                        <i class="fas fa-percentage text-red-500 ml-3"></i>
