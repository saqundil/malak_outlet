...
@section('page-title', 'لوحة التحكم الشاملة')
@section('page-description', 'نظرة شاملة على جميع بيانات المتجر والإحصائيات التفصيلية')
...
<div class="space-y-8">
        ...
        <div class="dashboard-card p-6" style="--icon-color-1: #3b82f6; --icon-color-2: #1e40af;">
            ...
            <div class="space-y-2">
                ...
                <div class="progress-bar">
                    <div class="progress-fill" style="--progress-color-1: #10b981; --progress-color-2: #059669; width: {{ $stats['total_products'] > 0 ? ($stats['active_products'] / $stats['total_products']) * 100 : 0 }}%;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-card p-6" style="--icon-color-1: #10b981; --icon-color-2: #059669;">
            ...
            <div class="space-y-2">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-bold text-orange-600">{{ $stats['pending_orders'] }}</span>
                </div>
                <div class="progress-bar">
                    <div class="progress-fill" style="--progress-color-1: #f59e0b; --progress-color-2: #d97706; width: {{ $stats['total_orders'] > 0 ? ($stats['pending_orders'] / $stats['total_orders']) * 100 : 0 }}%;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-card p-6" style="--icon-color-1: #f59e0b; --icon-color-2: #d97706;">
            ...
            <div class="space-y-2">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-bold text-blue-600">{{ number_format($stats['average_order_value'], 2) }} د.أ</span>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-card p-6" style="--icon-color-1: #8b5cf6; --icon-color-2: #7c3aed;">
            ...
            <div class="space-y-2">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-bold text-pink-600">{{ $stats['total_favorites'] }}</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="table-card">
            ...
            <div class="table-content space-y-3">
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-blue-600">{{ $stats['total_products'] }}</span>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-purple-600">{{ $stats['total_categories'] }}</span>
                        <a href="{{ route('admin.categories.index') }}" class="text-purple-500 hover:text-purple-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-indigo-600">{{ $stats['total_brands'] }}</span>
                        <a href="{{ route('admin.brands.index') }}" class="text-indigo-500 hover:text-indigo-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-green-600">{{ $stats['total_product_images'] }}</span>
                        <a href="{{ route('admin.products.index') }}" class="text-green-500 hover:text-green-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-orange-600">{{ $stats['total_product_sizes'] }}</span>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-teal-600">{{ $stats['total_product_attributes'] }}</span>
                        <a href="{{ route('admin.products.index') }}" class="text-teal-500 hover:text-teal-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
        ...
        <div class="table-card">
            ...
            <div class="table-content space-y-3">
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-green-600">{{ $stats['total_orders'] }}</span>
                        <a href="{{ route('admin.orders.index') }}" class="text-green-500 hover:text-green-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-orange-600">{{ $stats['pending_orders'] }}</span>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-blue-600">{{ $stats['completed_orders'] }}</span>
                        <a href="{{ route('admin.orders.index') }}?status=completed" class="text-blue-500 hover:text-blue-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-purple-600">{{ $stats['total_order_items'] }}</span>
                        <a href="{{ route('admin.orders.index') }}" class="text-purple-500 hover:text-purple-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-indigo-600">{{ $stats['total_jordan_cities'] }}</span>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-lg font-bold text-yellow-600">{{ number_format($stats['average_order_value'], 2) }}</span>
        ...
        <div class="table-card">
            ...
            <div class="table-content space-y-3">
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-purple-600">{{ $stats['total_customers'] }}</span>
                        <a href="{{ route('admin.users.index') }}" class="text-purple-500 hover:text-purple-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-yellow-600">{{ $stats['total_reviews'] }}</span>
                        <a href="{{ route('admin.reviews.index') }}" class="text-yellow-500 hover:text-yellow-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-green-600">{{ $stats['approved_reviews'] }}</span>
                        <a href="{{ route('admin.reviews.index') }}?status=approved" class="text-green-500 hover:text-green-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-pink-600">{{ $stats['total_favorites'] }}</span>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-red-600">{{ $stats['total_discounts'] }}</span>
                        <a href="{{ route('admin.discounts.index') }}" class="text-red-500 hover:text-red-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mini-stat">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xl font-bold text-orange-600">{{ $stats['total_discount_products'] }}</span>
                        <a href="{{ route('admin.products.index') }}?has_discount=1" class="text-orange-500 hover:text-orange-700">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
    ...
    <!-- Quick Actions Grid -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <a href="{{ route('admin.products.create') }}" class="quick-action" style="--action-color-1: #3b82f6; --action-color-2: #1e40af;">
            <div class="flex items-center justify-between">
                <div>
        ...
        <a href="{{ route('admin.orders.index') }}" class="quick-action" style="--action-color-1: #10b981; --action-color-2: #059669;">
            <div class="flex items-center justify-between">
                <div>
        ...
        <a href="{{ route('admin.discounts.create') }}" class="quick-action" style="--action-color-1: #ef4444; --action-color-2: #dc2626;">
            <div class="flex items-center justify-between">
                <div>
        ...
        <a href="{{ route('admin.users.index') }}" class="quick-action" style="--action-color-1: #8b5cf6; --action-color-2: #7c3aed;">
            <div class="flex items-center justify-between">
                <div>
                ...
                @if($recentOrders->count() > 0)
                    ...
                    <div class="activity-item">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600">{{ $order->user->name ?? 'زائر' }} - {{ number_format($order->total_amount) }} د.أ</p>
            ...
            <div>
                ...
                @if(isset($recentReviews) && $recentReviews->count() > 0)
                    ...
                    <div class="activity-item">
                        ...
                        <div class="flex-1">
                            <p class="font-medium text-gray-900">{{ $review->product->name ?? 'منتج محذوف' }}</p>
                            <p class="text-sm text-gray-600">{{ $review->user->name ?? 'زائر' }} - {{ $review->rating }}/5</p>
                ...
                @if($topProducts->count() > 0)
                    ...
                    <div class="activity-item">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600">{{ number_format($product->price) }} د.أ</p>
