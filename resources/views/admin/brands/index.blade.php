...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <div class="flex items-center">
            ...
            <div class="mr-4">
                <h3 class="text-2xl font-bold text-gray-900">{{ $brands->total() }}</h3>
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <div class="flex items-center">
            ...
            <div class="mr-4">
                <h3 class="text-2xl font-bold text-gray-900">{{ $brands->where('is_active', true)->count() }}</h3>
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <div class="flex items-center">
            ...
            <div class="mr-4">
                <h3 class="text-2xl font-bold text-gray-900">{{ $brands->where('is_active', false)->count() }}</h3>
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <div class="flex items-center">
            ...
            <div class="mr-4">
                <h3 class="text-2xl font-bold text-gray-900">{{ $brands->sum(function($brand) { return $brand->products->count(); }) }}</h3>
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <form method="GET" class="flex flex-col lg:flex-row gap-4 flex-1">
            ...
            <select name="sort" class="border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                <option value="name" {{ request('sort') == 'name' ? 'selected' : '' }}>ترتيب بالاسم</option>
                <option value="created_at" {{ request('sort') == 'created_at' ? 'selected' : '' }}>ترتيب بتاريخ الإنشاء</option>
                <option value="products_count" {{ request('sort') == 'products_count' ? 'selected' : '' }}>ترتيب بعدد المنتجات</option>
            </select>
...
<script>
    ...
    function bulkAction(action) {
        ...
        if (confirm(message)) {
            ...
            document.getElementById('bulk-form').action = '{{ route("admin.brands.bulk") }}';
