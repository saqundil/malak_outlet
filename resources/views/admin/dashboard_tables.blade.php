...
@section('title', 'نظرة عامة على قواعد البيانات')
@section('page-title', 'إدارة قواعد البيانات')
@section('page-description', 'نظرة شاملة على جميع جداول قاعدة البيانات وإحصائياتها')
...
<div class="space-y-8">
    ...
    <div class="summary-card">
        ...
        <p class="opacity-90">جميع البيانات المخزنة عبر {{ 16 }} جدول رئيسي</p>
    </div>
        ...
        <div class="table-card" style="--header-color-1: #3b82f6; --header-color-2: #1e40af;">
            ...
            <div class="stat-grid">
                <div class="stat-item">
                    ...
                    <span class="text-xl font-bold text-blue-600">{{ number_format($stats['total_products']) }}</span>
                </div>
                <div class="stat-item">
                ...
                <div class="stat-item">
                    ...
                    <span class="font-bold text-yellow-600">{{ $stats['featured_products'] }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">مخزون منخفض</span>
                    <span class="font-bold text-red-600">{{ $stats['low_stock_products'] }}</span>
                </div>
                <div class="action-buttons">
                    <a href="{{ route('admin.products.index') }}" class="action-btn btn-primary">عرض الكل</a>
                    <a href="{{ route('admin.products.create') }}" class="action-btn btn-success">إضافة جديد</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-card" style="--header-color-1: #10b981; --header-color-2: #059669;">
            ...
            <div class="stat-grid">
                <div class="stat-item">
                    ...
                    <span class="text-xl font-bold text-green-600">{{ number_format($stats['total_orders']) }}</span>
                </div>
                <div class="stat-item">
                ...
                <div class="stat-item">
                    ...
                    <span class="font-bold text-blue-600">{{ $stats['completed_orders'] }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">إجمالي المبيعات</span>
                    <span class="font-bold text-green-600">{{ number_format($stats['total_revenue'], 2) }} د.أ</span>
                </div>
                <div class="action-buttons">
                    <a href="{{ route('admin.orders.index') }}" class="action-btn btn-primary">عرض الكل</a>
                    <a href="{{ route('admin.orders.index') }}?status=pending" class="action-btn btn-secondary">المعلقة</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-card" style="--header-color-1: #8b5cf6; --header-color-2: #7c3aed;">
            ...
            <div class="stat-grid">
                <div class="stat-item">
                    ...
                    <span class="text-xl font-bold text-purple-600">{{ number_format($stats['total_customers']) }}</span>
                </div>
                <div class="stat-item">
                ...
                <div class="stat-item">
                    ...
                    <span class="font-bold text-yellow-600">{{ $stats['total_reviews'] }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">مراجعات موافقة</span>
                    <span class="font-bold text-green-600">{{ $stats['approved_reviews'] }}</span>
                </div>
                <div class="action-buttons">
                    <a href="{{ route('admin.users.index') }}" class="action-btn btn-primary">عرض العملاء</a>
                    <a href="{{ route('admin.reviews.index') }}" class="action-btn btn-secondary">المراجعات</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-card" style="--header-color-1: #f59e0b; --header-color-2: #d97706;">
            ...
            <div class="stat-grid">
                <div class="stat-item">
                    ...
                    <span class="text-xl font-bold text-orange-600">{{ number_format($stats['total_categories']) }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">فئات رئيسية</span>
                    <span class="font-bold text-blue-600">{{ $recentCategories->where('parent_id', null)->count() }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">فئات فرعية</span>
                    <span class="font-bold text-purple-600">{{ $recentCategories->where('parent_id', '!=', null)->count() }}</span>
                </div>
                <div class="action-buttons">
                    <a href="{{ route('admin.categories.index') }}" class="action-btn btn-primary">عرض الكل</a>
                    <a href="{{ route('admin.categories.create') }}" class="action-btn btn-success">إضافة جديد</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-card" style="--header-color-1: #ef4444; --header-color-2: #dc2626;">
            ...
            <div class="stat-grid">
                <div class="stat-item">
                    ...
                    <span class="text-xl font-bold text-red-600">{{ number_format($stats['total_brands']) }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">علامات نشطة</span>
                    <span class="font-bold text-green-600">{{ $recentBrands->where('is_active', true)->count() }}</span>
                </div>
                <div class="action-buttons">
                    <a href="{{ route('admin.brands.index') }}" class="action-btn btn-primary">عرض الكل</a>
                    <a href="{{ route('admin.brands.create') }}" class="action-btn btn-success">إضافة جديد</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-card" style="--header-color-1: #ec4899; --header-color-2: #be185d;">
            ...
            <div class="stat-grid">
                <div class="stat-item">
                    ...
                    <span class="text-xl font-bold text-pink-600">{{ number_format($stats['total_discounts']) }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">خصومات نشطة</span>
                    <span class="font-bold text-green-600">{{ $stats['active_discounts'] }}</span>
                </div>
                <div class="stat-item">
                    <span class="text-sm text-gray-600">منتجات مخفضة</span>
                    <span class="font-bold text-orange-600">{{ $stats['total_discount_products'] }}</span>
                </div>
                <div class="action-buttons">
                    <a href="{{ route('admin.discounts.index') }}" class="action-btn btn-primary">عرض الكل</a>
                    <a href="{{ route('admin.discounts.create') }}" class="action-btn btn-success">إضافة جديد</a>
                </div>
            </div>
        </div>
            ...
            <div class="table-card" style="--header-color-1: #06b6d4; --header-color-2: #0891b2;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-cyan-600">{{ $stats['total_product_images'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="table-card" style="--header-color-1: #84cc16; --header-color-2: #65a30d;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-lime-600">{{ $stats['total_product_sizes'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="table-card" style="--header-color-1: #a855f7; --header-color-2: #9333ea;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-violet-600">{{ $stats['total_order_items'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="table-card" style="--header-color-1: #059669; --header-color-2: #047857;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-emerald-600">{{ $stats['total_jordan_cities'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="table-card" style="--header-color-1: #f97316; --header-color-2: #ea580c;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-orange-600">{{ $stats['total_product_attributes'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="table-card" style="--header-color-1: #0d9488; --header-color-2: #0f766e;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-teal-600">{{ $stats['total_attribute_values'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="table-card" style="--header-color-1: #e11d48; --header-color-2: #be123c;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-rose-600">{{ $stats['total_favorites'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="table-card" style="--header-color-1: #eab308; --header-color-2: #ca8a04;">
                ...
                <div class="stat-grid">
                    <div class="stat-item">
                        ...
                        <span class="text-lg font-bold text-yellow-600">{{ $stats['total_reviews'] }}</span>
                    </div>
                </div>
            </div>
    ...
    <div class="mt-12 bg-gray-50 rounded-2xl p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ route('admin.categories.create') }}" class="action-btn btn-secondary">
                <i class="fas fa-folder-plus mr-2"></i>إضافة فئة جديدة
            </a>
            <a href="{{ route('admin.brands.create') }}" class="action-btn btn-success">
                <i class="fas fa-tag mr-2"></i>إضافة علامة تجارية
            </a>
            <a href="{{ route('admin.discounts.create') }}" class="action-btn btn-primary">
