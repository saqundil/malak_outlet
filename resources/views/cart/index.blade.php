                ...
                <div class="lg:col-span-8">
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-100">
                            ...
                            <div class="p-6 cart-item hover:bg-gray-50 transition-colors duration-200" data-cart-key="{{ $item['cart_key'] }}">
                                <div class="flex items-start gap-6">
                                    ...
                                    <div class="text-left flex-shrink-0">
                                        ...
                                        <div class="text-lg font-bold text-gray-900 mb-2">{{ number_format($item['price'], 2) }} ر.س</div>
                                        @if($item['quantity'] > 1)
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex justify-between text-lg">
                                    ...
                                    <span class="font-bold text-2xl text-orange-600">{{ number_format($total, 2) }} ر.س</span>
                                </div>
                            </div>
                        </div>
