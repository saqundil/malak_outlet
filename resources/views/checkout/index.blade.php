                        ...
                        <div class="bg-white rounded-lg shadow-md p-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input dir="rtl" type="tel" id="phone" name="phone" value="{{ old('phone', auth()->user()->phone ?? '') }}" required
                                    ...
                                    <select id="jordan_city_id" name="jordan_city_id" required
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{ $city->id }}" 
                                                    data-delivery-cost="{{ $city->delivery_cost }}"
                                                    data-delivery-days="{{ $city->delivery_days }}"
                                                    {{ old('jordan_city_id') == $city->id ? 'selected' : '' }}>
                                                {{ $city->name_ar }} - {{ $city->formatted_delivery_cost }}
                                                ({{ $city->delivery_days == 1 ? 'يوم واحد' : $city->delivery_days . ' أيام' }})
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('jordan_city_id')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <textarea id="shipping_address" name="shipping_address" rows="4" required
                                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                                              placeholder="الحي، اسم الشارع، رقم المبنى، الطابق، أي معلومات إضافية للوصول">{{ old('shipping_address') }}</textarea>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-8 sticky top-4">
                                    ...
                                    <div class="flex items-center space-x-4 space-x-reverse">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex justify-between items-center mt-1">
                                                ...
                                                <span class="font-medium">{{ number_format($item['total'], 2) }} د.أ</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="border-t pt-4 space-y-2">
                                ...
                                <div class="flex justify-between text-gray-600">
                                    ...
                                    <span class="line-through text-gray-400">{{ number_format($totalOriginal, 2) }} د.أ</span>
                                </div>
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span id="subtotal-display">{{ number_format($subtotal, 2) }} د.أ</span>
                                </div>
                                ...
                                <div class="flex justify-between text-lg font-bold border-t pt-2">
                                    <span>الإجمالي:</span>
                                    <span id="total-display" class="text-orange-600">{{ number_format($total, 2) }} د.أ</span>
                                </div>
                                @if($totalSavings > 0)
