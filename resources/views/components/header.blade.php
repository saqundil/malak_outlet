    ...
    <div class="container mx-auto max-w-full">
        ...
        <div class="flex items-center justify-between flex-wrap gap-2 sm:gap-4">
            ...
            <div class="flex items-center order-1">
                <a href="{{ route('home') }}" class="text-lg sm:text-xl lg:text-3xl font-bold text-white no-underline flex items-center hover:scale-105 transition-transform duration-200">
                <img src="{{ asset('images/malak.png') }}" alt="MalakOutlet Logo" class="w-12 h-12 sm:w-16 sm:h-16 md:w-20 lg:w-20 ml-2 hover:opacity-80 transition-opacity duration-200" />
            ...
            <div class="flex items-center order-3 gap-2 sm:gap-3">
                ...
                <div class="relative md:hidden" x-data="{ menuOpen: false }">
                    ...
                    <div x-show="menuOpen" 
                        ...
                        <!-- Menu Items -->
                        <div class="py-2">
                            <a href="{{ route('home') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200 group">
                            ...
                            <a href="{{ route('products.index') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200 group">
                                <svg class="w-4 h-4 ml-3 text-gray-400 group-hover:text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('products.category', 'toys-games') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200 group">
                                <svg class="w-4 h-4 ml-3 text-gray-400 group-hover:text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('products.category', 'electronics') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200 group">
                                <svg class="w-4 h-4 ml-3 text-gray-400 group-hover:text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @guest
                                <div class="border-t border-gray-100 mt-2 pt-2">
                                    <a href="{{ route('login') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200 group">
                                        <svg class="w-4 h-4 ml-3 text-gray-400 group-hover:text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @else
                                <div class="border-t border-gray-100 mt-2 pt-2">
                                    <div class="px-4 py-2 bg-orange-50 border-l-4 border-orange-400">
                                        ...
                                        <p class="text-sm font-semibold text-gray-800 text-right truncate">{{ auth()->user()->name }}</p>
                                    </div>
                                    
                                    <a href="{{ route('profile') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200 group">
                                        <svg class="w-4 h-4 ml-3 text-gray-400 group-hover:text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                        </svg>
                                    ...
                                    <a href="{{ route('orders.index') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200 group">
                                        <svg class="w-4 h-4 ml-3 text-gray-400 group-hover:text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @if(auth()->user()->is_admin)
                                        <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 text-orange-600 hover:bg-orange-50 transition-colors duration-200 group font-medium">
                ...
                <a href="{{ route('wishlist') }}" class="relative group p-1.5 sm:p-2 hover:bg-gray-200 hover:bg-opacity-10 rounded-lg transition-all duration-200 hidden sm:block">
                ...
                <!-- Enhanced Cart Icon -->
                <a href="{{ route('cart') }}" class="relative group p-1.5 sm:p-2 hover:bg-gray-200 hover:bg-opacity-10 rounded-lg transition-all duration-200">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 group-hover:scale-110 transition-transform duration-200" viewBox="0 0 24 24" fill="none">
        ...
        <div x-show="mobileSearchOpen" 
            ...
            <div class="relative bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20">
                ...
                <form action="{{ route('search') }}" method="GET" class="flex w-full bg-white rounded-lg overflow-hidden shadow-lg">
                    <input type="text" 
                           name="q" 
                           value="{{ request('q') }}" 
