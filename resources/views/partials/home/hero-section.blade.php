...
<section class="flex flex-col-reverse md:flex-row-reverse bg-orange-50 my-5 rounded-lg overflow-hidden relative">
    ...
    <div class="p-5 md:p-10 w-full md:w-1/2 text-right">
        ...
        <a href="{{ route('products.category', 'toys') }}" class="inline-block py-2 px-6 md:py-3 md:px-8 bg-orange-500 text-white no-underline rounded font-bold transition-colors hover:bg-orange-600 text-sm md:text-base">تسوق ألعاب الآن</a>
    </div>
</section>
