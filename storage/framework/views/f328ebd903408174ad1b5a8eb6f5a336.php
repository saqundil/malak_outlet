    ...
    <div class="container mx-auto">
        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex items-center order-1">
                <a href="<?php echo e(route('home')); ?>" class="text-xl lg:text-3xl font-bold text-white no-underline flex items-center hover:scale-105 transition-transform duration-200">
                <img src="<?php echo e(asset('images/malak.png')); ?>" alt="MalakOutlet Logo" class="w-16 md:w-20 lg:w-20 ml-2 hover:opacity-80 transition-opacity duration-200" />
            ...
            <div class="flex items-center order-3 gap-3">
                ...
                <a href="<?php echo e(route('wishlist')); ?>" class="relative group p-2 hover:bg-gray-200 hover:bg-opacity-10 rounded-lg transition-all duration-200 hidden sm:block">
                ...
                <!-- Enhanced Cart Icon -->
                <a href="<?php echo e(route('cart')); ?>" class="relative group p-2 hover:bg-gray-200 hover:bg-opacity-10 rounded-lg transition-all duration-200">
                    <svg class="w-6 h-6 md:w-7 md:h-7 group-hover:scale-110 transition-transform duration-200" viewBox="0 0 24 24" fill="none">
        ...
        <div class="w-full order-4 mt-4 md:hidden" x-data="mobileSearchBox()">
            <div class="relative">
                <form action="<?php echo e(route('search')); ?>" method="GET" class="flex w-full bg-white rounded-xl overflow-hidden shadow-lg">
                    <input type="text" 
                           name="q" 
                           value="<?php echo e(request('q')); ?>" 
