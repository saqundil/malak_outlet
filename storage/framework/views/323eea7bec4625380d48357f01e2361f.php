...
<?php $__env->startSection('title', 'تحقق من البريد الإلكتروني - Malak Outlet'); ?>
...
<div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div>
            <div class="text-center">
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    <?php if($email): ?>
                        <br><strong class="text-orange-600"><?php echo e($email); ?></strong>
                    <?php endif; ?>
                </p>
            </div>
        </div>
        ...
        <form class="mt-8 space-y-6" id="otpForm" method="POST" action="<?php echo e(route('verify.otp')); ?>">
            <?php echo csrf_field(); ?>
            <div>
                <?php if($email): ?>
                ...
                <?php else: ?>
                    <div class="mb-4">
                        ...
                        <input type="email" 
                               name="email" 
                               id="email"
                               class="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 focus:z-10 sm:text-sm <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex space-x-2 space-x-reverse justify-center">
                        <?php for($i = 0; $i < 6; $i++): ?>
                            <input type="text" 
                                   class="otp-input w-12 h-12 text-center text-lg font-bold border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 <?php $__errorArgs = ['otp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
        ...
        .then(data => {
            if (data.success) {
                ...
                setTimeout(() => {
                    ...
                    const redirectUrl = data.redirect_url || '<?php echo e(route("home")); ?>';
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Malak_E_commers\malak_outlet\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>