...
<?php $__env->startSection('title', 'شروط الاستخدام - متجر ملاك'); ?>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                <div class="mb-8">
                    <p class="text-gray-600 leading-relaxed">
                        آخر تحديث: <?php echo e(date('Y/m/d')); ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-gray-600 mr-4">
                                <li>• جميع الأسعار بالدينار الأردني وتشمل ضريبة القيمة المضافة</li>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">
                        هذه الشروط محكومة بالقوانين السارية في المملكة الأردنية الهاشمية. 
                        أي نزاع ينشأ عن هذه الشروط يخضع لاختصاص المحاكم الأردنية.
                    </p>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Malak_E_commers\malak_outlet\resources\views/terms.blade.php ENDPATH**/ ?>