...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mx-auto px-4 py-12">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="space-y-2">
                    ...
                    <p class="text-lg text-gray-600">
                        لديك 
                        <span id="wishlist-count" class="font-bold text-orange-600 text-xl"><?php echo e($favorites->count()); ?></span> 
                        <?php echo e($favorites->count() == 1 ? 'منتج' : 'منتجات'); ?> في قائمة الأمنيات
                    </p>
                </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="wishlist-items">
            ...
            <!-- Modern Card Design -->
            <div class="modern-card wishlist-item group" data-product-id="<?php echo e($favorite->product->slug); ?>">
                <!-- Image Container -->
                <div class="card-image-container">
                    <div class="aspect-[4/5] overflow-hidden relative">
                        ...
                        <?php else: ?>
                            <div class="w-full h-full bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                                <div class="text-center p-6">
                                    ...
                                    <span class="text-slate-600 font-medium text-sm"><?php echo e($favorite->product->name); ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="floating-badge sale-badge">
                            ...
                            <span class="badge-percent">-<?php echo e(round((($favorite->product->price - $favorite->product->sale_price) / $favorite->product->price) * 100)); ?>%</span>
                        </div>
                        <?php endif; ?>
                        
                        <!-- Heart Button -->
                        <button class="floating-heart remove-from-wishlist" data-product-id="<?php echo e($favorite->product->slug); ?>">
                        ...
                        <div class="quick-actions-overlay">
                            <button class="quick-action-btn add-to-cart" data-product-id="<?php echo e($favorite->product->slug); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 2.5M7 13v6a1 1 0 001 1h10a1 1 0 001-1v-6m-8 0V9a1 1 0 011-1h4a1 1 0 011 1v4"/>
                                </svg>
                                <span>إضافة للسلة</span>
                            </button>
                            <a href="<?php echo e(route('products.show', $favorite->product->slug)); ?>" class="quick-action-btn view-btn">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="card-content">
                    ...
                    <div class="category-tag">
                        <?php echo e($favorite->product->category->name ?? 'فئة غير محددة'); ?>
                    ...
                    <div class="rating-container">
                        <div class="stars-wrapper">
                            <?php $__currentLoopData = range(1, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <svg class="star <?php echo e($star <= ($favorite->product->average_rating ?? 0) ? 'star-filled' : 'star-empty'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                </svg>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <span class="reviews-count">(<?php echo e($favorite->product->reviews_count ?? 0); ?>)</span>
                    </div>
                    ...
                    <div class="price-section">
                        <?php if($favorite->product->sale_price): ?>
                            <div class="price-row">
                                <span class="current-price"><?php echo e(number_format($favorite->product->sale_price, 2)); ?> د.أ</span>
                                <span class="old-price"><?php echo e(number_format($favorite->product->price, 2)); ?> د.أ</span>
                            </div>
                        <?php else: ?>
                            <div class="price-row">
                                <span class="current-price single-price"><?php echo e(number_format($favorite->product->price, 2)); ?> د.أ</span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="text-center py-20" id="empty-wishlist">
            <div class="max-w-md mx-auto">
                ...
                <div class="space-y-4">
                    <a href="<?php echo e(route('home')); ?>" class="premium-btn premium-btn-primary inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-semibold">
