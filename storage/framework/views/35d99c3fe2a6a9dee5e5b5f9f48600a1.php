...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="wishlist-items">
            ...
            <!-- Wishlist Item -->
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group wishlist-item" data-product-id="<?php echo e($favorite->product->slug); ?>">
                <div class="relative">
                    ...
                    <button class="absolute top-3 left-3 p-2 bg-white rounded-full shadow-lg hover:bg-red-50 transition-colors remove-from-wishlist" data-product-id="<?php echo e($favorite->product->slug); ?>">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-2 mb-3">
                        <?php if($favorite->product->sale_price): ?>
                            <span class="text-xl font-bold text-red-600"><?php echo e(number_format($favorite->product->sale_price, 2)); ?> د.أ</span>
                            <span class="text-sm text-gray-500 line-through"><?php echo e(number_format($favorite->product->price, 2)); ?> د.أ</span>
                        <?php else: ?>
                            <span class="text-xl font-bold text-gray-800"><?php echo e(number_format($favorite->product->price, 2)); ?> د.أ</span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="flex gap-2">
                        <button class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors font-semibold add-to-cart" data-product-id="<?php echo e($favorite->product->slug); ?>">
                            إضافة للسلة
                        </button>
                        <a href="<?php echo e(route('products.show', $favorite->product->slug)); ?>" 
