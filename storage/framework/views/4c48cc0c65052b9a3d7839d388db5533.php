...
<?php $__env->startSection('title', 'العروض والخصومات - متجر ملاك'); ?>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-8 text-white relative overflow-hidden">
                <div class="relative z-10">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="bg-white text-orange-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block">
                        تسوق الآن
                    </a>
                </div>
            ...
            <div class="bg-gradient-to-r from-green-400 to-blue-500 rounded-2xl p-8 text-white">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="bg-white text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block">
                    ابدأ التسوق
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Malak_E_commers\malak_outlet\resources\views/offers.blade.php ENDPATH**/ ?>