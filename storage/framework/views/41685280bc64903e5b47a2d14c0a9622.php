...
<?php $__env->startSection('title', 'اتصل بنا - متجر ملاك'); ?>
        ...
        <div class="max-w-6xl mx-auto">
                ...
                <div class="space-y-6 sm:space-y-8">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm sm:text-base text-gray-600 leading-relaxed whitespace-pre-line"><?php echo e($contactInfo['address'] ?? 'لم يتم تحديد العنوان بعد'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm sm:text-base text-gray-600 font-medium" dir="ltr">
                                            <a href="tel:<?php echo e(str_replace(['+', ' '], '', $contactInfo['phone'] ?? '')); ?>" 
                                               class="hover:text-blue-600 transition-colors">
                                                <?php echo e($contactInfo['phone'] ?? 'لم يتم تحديد الهاتف بعد'); ?>

                                            </a>
                                        </p>
                                        <p class="text-xs sm:text-sm text-gray-500 mt-1 leading-relaxed whitespace-pre-line"><?php echo e($contactInfo['phone_hours'] ?? ''); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <?php if($contactInfo['email_info']): ?>
                                        <p class="text-sm sm:text-base text-gray-600 break-all">
                                            <a href="mailto:<?php echo e($contactInfo['email_info']); ?>" 
                                               class="hover:text-purple-600 transition-colors">
                                                <?php echo e($contactInfo['email_info']); ?>

                                            </a>
                                        </p>
                                        <?php endif; ?>
                                        <?php if($contactInfo['email_support']): ?>
                                        <p class="text-sm sm:text-base text-gray-600 break-all">
                                            <a href="mailto:<?php echo e($contactInfo['email_support']); ?>" 
                                               class="hover:text-purple-600 transition-colors">
                                        ...
                                        <?php endif; ?>
                                        <?php if($contactInfo['email_response_time']): ?>
                                        <p class="text-xs sm:text-sm text-gray-500 mt-1"><?php echo e($contactInfo['email_response_time']); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <a href="<?php echo e($contactInfo['whatsapp_url'] ?? '#'); ?>" 
                                           class="text-sm sm:text-base text-green-600 hover:text-green-800 font-medium" 
                                           dir="ltr"><?php echo e($contactInfo['whatsapp']); ?></a>
                                        <?php endif; ?>
                                        <?php if($contactInfo['whatsapp_description']): ?>
                                        <p class="text-xs sm:text-sm text-gray-500 mt-1"><?php echo e($contactInfo['whatsapp_description']); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8">
                        ...
                        <div class="space-y-2 sm:space-y-3">
                            <?php if(isset($businessHours['hours']) && is_array($businessHours['hours'])): ?>
                                <?php $__currentLoopData = $businessHours['hours']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                        <span class="font-medium text-gray-800 text-sm sm:text-base"><?php echo e($period['label'] ?? ''); ?></span>
                                        <span class="<?php echo e(isset($period['closed']) && $period['closed'] ? 'text-red-600 font-medium' : 'text-gray-600'); ?> text-sm sm:text-base">
                                            <?php echo e($period['hours'] ?? ''); ?>
                        ...
                        <?php if($businessHours['whatsapp_24_7']): ?>
                        <div class="mt-4 sm:mt-6 p-3 sm:p-4 bg-blue-50 rounded-lg">
                            <p class="text-xs sm:text-sm text-blue-800">
                                ...
                                <?php echo e($businessHours['whatsapp_24_7']); ?>
            ...
            <div class="mt-12 sm:mt-16 bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    <a href="<?php echo e(route('faq')); ?>" class="p-4 sm:p-6 border border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition duration-200">
                    ...
                    <a href="<?php echo e(route('returns')); ?>" class="p-4 sm:p-6 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition duration-200">
                    ...
                    <a href="<?php echo e(route('faq')); ?>" class="p-4 sm:p-6 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition duration-200 sm:col-span-2 lg:col-span-1">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Malak_E_commers\malak_outlet\resources\views/contact.blade.php ENDPATH**/ ?>