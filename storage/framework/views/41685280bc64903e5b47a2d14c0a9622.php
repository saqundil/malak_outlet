        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mt-16 bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <a href="<?php echo e(route('faq')); ?>" class="p-6 border border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition duration-200">
                    ...
                    <a href="<?php echo e(route('returns')); ?>" class="p-6 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition duration-200">
                    ...
                    <a href="<?php echo e(route('faq')); ?>" class="p-6 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition duration-200">
