        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <?php if($errors->get('name')): ?>
                    <p class="text-red-300 text-sm font-medium"><?php echo e(implode(' ', $errors->get('name'))); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="space-y-2">
                ...
                <?php if($errors->get('phone')): ?>
                    <p class="text-red-300 text-sm font-medium"><?php echo e(implode(' ', $errors->get('phone'))); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <?php if($errors->get('password_confirmation')): ?>
                        <p class="text-red-300 text-sm font-medium"><?php echo e(implode(' ', $errors->get('password_confirmation'))); ?></p>
                    <?php endif; ?>
                </div>
            </div>
