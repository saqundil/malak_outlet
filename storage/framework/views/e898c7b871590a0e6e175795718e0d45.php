...
<?php $__env->startSection('title', 'تم الطلب بنجاح - متجر ملاك'); ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-8 mb-8 text-right">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center border-b pb-2">
                        ...
                        <span class="text-blue-600 font-bold">#<?php echo e($order->order_number); ?></span>
                    </div>
                    
                    <div class="flex justify-between items-center border-b pb-2">
                        <span class="font-medium">التاريخ:</span>
                        <span><?php echo e($order->created_at->format('Y/m/d H:i')); ?></span>
                    </div>
                    
                    <div class="flex justify-between items-center border-b pb-2">
                        <span class="font-medium">الإجمالي:</span>
                        <span class="text-green-600 font-bold"><?php echo e(number_format($order->total_amount, 2)); ?> د.أ</span>
                    </div>
                    
                    <div class="flex justify-between items-center border-b pb-2">
                        <span class="font-medium">طريقة الدفع:</span>
                        <span><?php echo e($order->payment_method === 'cod' ? 'الدفع عند الاستلام' : 'دفع إلكتروني'); ?></span>
                    </div>
                    
                    <div class="flex justify-between items-start border-b pb-2">
                        <span class="font-medium">عنوان الشحن:</span>
                        <span class="text-left max-w-xs"><?php echo e($order->shipping_address); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between items-start border-b pb-2">
                        ...
                        <span class="text-left max-w-xs"><?php echo e($order->notes); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <?php else: ?>
                                    <div class="w-12 h-12 bg-gray-200 rounded flex items-center justify-center">
                                        <span class="text-xs text-gray-500"><?php echo e($item->product ? substr($item->product->name, 0, 2) : 'N/A'); ?></span>
                                    </div>
                                <?php endif; ?>
                                <div>
                                    <p class="font-medium"><?php echo e($item->product ? $item->product->name : 'منتج محذوف'); ?></p>
                                    <p class="text-sm text-gray-600">الكمية: <?php echo e($item->quantity); ?></p>
                                    <?php if($item->size): ?>
                                        <p class="text-sm text-gray-600">المقاس: <?php echo e($item->size); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <span class="font-semibold"><?php echo e(number_format($item->total, 2)); ?> د.أ</span>
                        </div>
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center border-b pb-2">
                        <span class="font-medium">رقم الطلب:</span>
                        <span class="text-blue-600 font-bold">#<?php echo e(session('last_order_number', '001')); ?></span>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Malak_E_commers\malak_outlet\resources\views/checkout/success.blade.php ENDPATH**/ ?>