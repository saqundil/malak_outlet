                            ...
                            <div class="flex flex-col">
                                <?php if($product->discount_percentage > 0): ?>
                                    <div class="flex items-center space-x-2 space-x-reverse">
                                        <span class="text-xl font-bold text-gradient"><?php echo e(number_format($product->final_price, 0)); ?> د.أ</span>
                                        <span class="text-sm text-gray-500 line-through"><?php echo e(number_format($product->price, 0)); ?> د.أ</span>
                                    </div>
                                    <span class="text-xs text-green-600 font-medium bg-green-50 px-2 py-1 rounded-full inline-block w-fit">وفّر <?php echo e(number_format($product->savings_amount, 0)); ?> د.أ</span>
                                <?php else: ?>
