...
<div class="min-h-screen bg-gray-50" dir="rtl">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6" id="orders-container">
            ...
            <!-- Order <?php echo e($loop->iteration); ?> - <?php echo e(ucfirst($order->status)); ?> -->
            <div class="bg-white rounded-xl shadow-lg overflow-hidden order-item" data-status="<?php echo e($order->status); ?>" data-order-id="<?php echo e($order->order_number); ?>">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <div>
                            <h3 class="text-lg font-bold text-gray-800">طلب رقم #<?php echo e($order->order_number); ?></h3>
                            <p class="text-gray-600">تاريخ الطلب: <?php echo e($order->created_at->format('j F Y')); ?></p>
                        </div>
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-lg font-bold text-gray-800"><?php echo e(number_format($order->total_amount, 2)); ?> د.أ</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-800"><?php echo e($item->product_name); ?></h4>
                                <p class="text-sm text-gray-600">الكمية: <?php echo e($item->quantity); ?> × <?php echo e(number_format($item->product_price, 2)); ?> د.أ</p>
                            </div>
                            <div class="text-right">
                                <p class="font-semibold"><?php echo e(number_format($item->total_price, 2)); ?> د.أ</p>
                            </div>
                        </div>
                    ...
                    <div class="mb-6 p-4 bg-blue-50 rounded-lg">
                        ...
                        <p class="text-sm text-blue-600 mt-3">التسليم المتوقع: <?php echo e($order->created_at->addDays(5)->format('j F Y')); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
                        <?php if($order->status == 'delivered'): ?>
                            <button onclick="trackOrder('<?php echo e($order->order_number); ?>')" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                                تتبع الطلب
                            </button>
                            <button onclick="reorderItems('<?php echo e($order->order_number); ?>')" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
                                إعادة الطلب
                            </button>
                            <button onclick="downloadInvoice('<?php echo e($order->order_number); ?>')" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
                                تحميل الفاتورة
                            </button>
                            <button onclick="rateProducts('<?php echo e($order->order_number); ?>')" class="bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition-colors">
                                تقييم المنتجات
                            </button>
                        <?php elseif($order->status == 'shipped'): ?>
                            ...
                            <button onclick="cancelOrder('<?php echo e($order->order_number); ?>')" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors">
                                إلغاء الطلب
                            </button>
                            <?php endif; ?>
                            <button onclick="downloadInvoice('<?php echo e($order->order_number); ?>')" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
                        ...
                        <?php elseif($order->status == 'pending'): ?>
                            ...
                            <button onclick="editOrder('<?php echo e($order->order_number); ?>')" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                                تعديل الطلب
                            </button>
                            <?php endif; ?>
                            <button onclick="viewOrderDetails('<?php echo e($order->order_number); ?>')" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
                                تفاصيل الطلب
                            </button>
                        <?php else: ?>
                            <button onclick="trackOrder('<?php echo e($order->order_number); ?>')" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
...
function viewOrderDetails(orderId) {
    ...
    fetch('<?php echo e(route("orders.show", ":orderId")); ?>'.replace(':orderId', orderId), {
        method: 'GET',
        headers: {
...
function saveOrderEdit(orderId) {
    ...
    fetch('<?php echo e(route("orders.update", ":orderId")); ?>'.replace(':orderId', orderId), {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
