...
<?php $__env->startSection('title', 'جميع الفئات - متجر ملاك'); ?>
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-2"><?php echo e($category->name); ?></h3>
                    <?php if($category->description): ?>
                        <p class="text-gray-600 text-sm mb-4"><?php echo e(Str::limit($category->description, 80)); ?></p>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Malak_E_commers\malak_outlet\resources\views/categories/index.blade.php ENDPATH**/ ?>