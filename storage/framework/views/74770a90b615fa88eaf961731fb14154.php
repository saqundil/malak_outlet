...
<main class="container mx-auto px-4" style="max-width: 1400px;">
            ...
            <div class="relative grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 md:p-12">
                <div class="flex flex-col justify-center text-white">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(route('products.index', ['filter' => 'sale'])); ?>" 
    ...
    <section class="my-8 md:my-12">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('products.index', ['filter' => 'popular'])); ?>" class="flex items-center text-orange-500 no-underline font-bold text-sm md:text-base group">
                <span class="group-hover:ml-2 transition-all">عرض الكل</span>
                <svg class="w-5 h-5 mr-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
                        ...
                        <div class="p-4">
                            <a href="<?php echo e(route('products.show', $product->slug)); ?>">
                                ...
                                <div class="flex items-center mb-3">
                                    <div class="flex text-yellow-400">
                                        <?php $__currentLoopData = range(1, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $starIndex): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <svg class="w-4 h-4 <?php echo e($starIndex <= round($product->average_rating ?? 4.5) ? 'fill-current' : 'text-gray-300'); ?>" viewBox="0 0 20 20">
                                                <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/>
                                            </svg>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <span class="text-gray-500 text-sm mr-2">(<?php echo e(number_format($product->average_rating ?? 4.5, 1)); ?>)</span>
                                </div>
