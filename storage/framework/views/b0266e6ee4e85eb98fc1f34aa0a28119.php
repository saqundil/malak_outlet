...
<div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg">
        <form method="GET" action="<?php echo e(route('admin.categories.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <!-- Search -->
            <div>
            ...
            <div class="md:col-span-4 flex gap-3">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg">
