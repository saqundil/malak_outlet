...
<?php $__env->startSection('title', 'سياسة الخصوصية - MalakOutlet'); ?>
...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600">تاريخ آخر تحديث: <?php echo e(date('Y/m/d')); ?></p>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Malak_E_commers\malak_outlet\resources\views/legal/privacy.blade.php ENDPATH**/ ?>