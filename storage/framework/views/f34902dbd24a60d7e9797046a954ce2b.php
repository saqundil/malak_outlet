                ...
                <div class="px-4 space-y-2">
                    ...
                    <div class="sidebar-section">
                        ...
                        <a href="<?php echo e(route('admin.dashboard')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.dashboard') && !request()->routeIs('admin.dashboard.enhanced') && !request()->routeIs('admin.dashboard.tables') ? 'active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('admin.products.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>">
                            ...
                            <?php if(isset($stats['total_products']) && $stats['total_products'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-blue-100 text-blue-800"><?php echo e($stats['total_products']); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.categories.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
                            ...
                            <?php if(isset($stats['total_categories']) && $stats['total_categories'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-purple-100 text-purple-800"><?php echo e($stats['total_categories']); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.brands.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.brands.*') ? 'active' : ''); ?>">
                            ...
                            <?php if(isset($stats['total_brands']) && $stats['total_brands'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-indigo-100 text-indigo-800"><?php echo e($stats['total_brands']); ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                    ...
                    <div class="sidebar-section">
                        ...
                        <a href="<?php echo e(route('admin.orders.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
                            ...
                            <?php if(isset($stats['total_orders']) && $stats['total_orders'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-green-100 text-green-800"><?php echo e($stats['total_orders']); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.orders.index')); ?>?status=pending" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors">
                            ...
                            <span class="mr-auto sidebar-badge bg-orange-100 text-orange-800"><?php echo e($stats['pending_orders']); ?></span>
                        </a>
                        <?php endif; ?>
                        ...
                        <a href="<?php echo e(route('admin.discounts.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.discounts.*') ? 'active' : ''); ?>">
                            ...
                            <?php if(isset($stats['total_discounts']) && $stats['total_discounts'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-red-100 text-red-800"><?php echo e($stats['total_discounts']); ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                    ...
                    <div class="sidebar-section">
                        ...
                        <a href="<?php echo e(route('admin.users.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
                            ...
                            <span>العملاء</span>
                            <?php if(isset($stats['total_customers']) && $stats['total_customers'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-blue-100 text-blue-800"><?php echo e($stats['total_customers']); ?></span>
                            <?php endif; ?>
                        </a>
                        
                        <a href="<?php echo e(route('admin.cities.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.cities.*') ? 'active' : ''); ?>">
                            <i class="fas fa-map-marker-alt mr-4"></i>
                            <span>المدن الأردنية</span>
                            <?php if(isset($stats['total_jordan_cities']) && $stats['total_jordan_cities'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-green-100 text-green-800"><?php echo e($stats['total_jordan_cities']); ?></span>
                            <?php endif; ?>
                        </a>
                        ...
                        <a href="<?php echo e(route('admin.reviews.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.reviews.*') ? 'active' : ''); ?>">
                            ...
                            <?php if(isset($stats['total_reviews']) && $stats['total_reviews'] > 0): ?>
                                <span class="mr-auto sidebar-badge bg-yellow-100 text-yellow-800"><?php echo e($stats['total_reviews']); ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                    ...
                    <div class="sidebar-section">
                        ...
                        <a href="<?php echo e(route('admin.settings.index')); ?>" 
                           class="sidebar-link flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>">
